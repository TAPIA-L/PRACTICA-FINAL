  ...
  <!-- page content -->
		 ...
		 <div class="item form-group">
           ...
           <div class="item form-group">
                  <label  class="col-form-label col-md-3 col-sm-3 label-align" for="contrasena"> Ingrese su Contrseña:<span class="required">*</span>
				  </label>
			      <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="contrasena" name="contrasena" value="<?= $fila->contrasena?>" required="required" class="form-control">
				  </div>
		     	</div>
