          ...
          <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Registrar <small>Fabricantes</small></h2>
                  ...
                  <div class="x_content">
				  <table border="1">
         <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"   action="<?= base_url("controlador_fabricante/adicionar");?>" method="POST" enctype="multipart/form-data">
